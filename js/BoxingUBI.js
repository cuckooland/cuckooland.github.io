...
(function () {
    ...
    var en_EN = {
      ...
      "months": ["Janary", "February", "March", "April", "May", "June", "Jully", "August", "September", "October", "November", "Décember"],
      "shortMonths": ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    };
    
    var enLocale = d3.locale(en_EN);
    
    //var formatNumber = d3.format(",.0f"),
    var formatNumber = enLocale.numberFormat(",.0f"),
    ...
    function noExch1ChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"noExch1_Ia1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"noExch1_Ia1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"noExch1_Ia1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"noExch1_Ia2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"noExch1_Ia2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"noExch1_Ia2"}
        ];
    }
    ...
    function noExch2ChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"noExch2_Ia1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"noExch2_Ia1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"noExch2_Ia1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"noExch2_Ia2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"noExch2_Ia2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"noExch2_Ia2"}
        ];
    }
    ...
    function nvFrancChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"nvFranc_I1a1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"nvFranc_I2a1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"nvFranc_I3a1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"nvFranc_I1a2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"nvFranc_I2a2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"nvFranc_I3a2"},
            {"name":"Di-1", "desc":"Destruction for referential change", "commentId":"nvFranc_Di1"}
        ];
    }
    ...
    function acFrancChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"acFranc_I1a1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"acFranc_I2a1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"acFranc_I3a1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"acFranc_I1a2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"acFranc_I2a2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"acFranc_I3a2"},
            {"name":"Cr-1", "desc":"Creation of money", "commentId":"acFranc_Cr1"}
        ];
    }
    ...
    function duQuantChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"duQuant_I1a1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"duQuant_I2a1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"duQuant_I3a1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"duQuant_I1a2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"duQuant_I2a2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"duQuant_I3a2"},
            {"name":"Cr-1", "desc":"Co-creation of money", "commentId":"duQuant_Cr1"}
        ];
    }
    ...
    function duRelChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"duRel_I1a1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"duRel_I2a1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"duRel_I3a1"},
            {"name":"I1-a2", "desc":"Amina - Year 2", "commentId":"duRel_I1a2"},
            {"name":"I2-a2", "desc":"Justine - Year 2", "commentId":"duRel_I2a2"},
            {"name":"I3-a2", "desc":"Liliane - Year 2", "commentId":"duRel_I3a2"},
            {"name":"I1-a2-mc", "desc":"Amina - Year 2 - In Franc of year 1", "commentId":"duRel_I1a2mc"},
            {"name":"I2-a2-mc", "desc":"Justine - Year 2 - In Franc of year 1", "commentId":"duRel_I2a2mc"},
            {"name":"I3-a2-mc", "desc":"Liliane - Year 2 - In Franc of year 1", "commentId":"duRel_I3a2mc"},
            {"name":"Cr-1", "desc":"Co-creation of money", "commentId":"duRel_Cr1"},
            {"name":"Di-1", "desc":"Residue coming from referential changing", "commentId":"duRel_Di1"}
        ];
    }
    ...
    function rdbChartNodes() {
        return [
            {"name":"I1-a1", "desc":"Amina - Year 1", "commentId":"rdb_I1a1"},
            {"name":"I2-a1", "desc":"Justine - Year 1", "commentId":"rdb_I2a1"},
            {"name":"I3-a1", "desc":"Liliane - Year 1", "commentId":"rdb_I3a1"},
            {"name":"I1-a2-mc", "desc":"Amina - Year 2", "commentId":"rdb_I1a2mc"},
            {"name":"I2-a2-mc","desc":"Justine - Year 2", "commentId":"rdb_I2a2mc"},
            {"name":"I3-a2-mc","desc":"Liliane - Year 2", "commentId":"rdb_I3a2mc"},
            {"name":"Ca-1", "desc":"Fund for UBI", "commentId":"rdb_Ca1"}
        ];
    }
    ...
    var charts = 
        [{id : "#noExch1", nodes : noExch1ChartNodes(), links : noExch1ChartLinks(), label : "Balanced exchanges"},
         {id : "#noExch2", nodes : noExch2ChartNodes(), links : noExch2ChartLinks(), label : "Balanced exchanges (simplified version)"},
         {id : "#nvFranc", nodes : nvFrancChartNodes(), links : nvFrancChartLinks(), label : "Changeover from the old to the new franc"},
         {id : "#acFranc", nodes : acFrancChartNodes(), links : acFrancChartLinks(), label : "Back to old franc"},
         {id : "#duQuant", nodes : duQuantChartNodes(), links : duQuantChartLinks(), label : "Universal Dividend via a monetary creation"},
         {id : "#duRel", nodes : duRelChartNodes(), links : duRelChartLinks(), label : "Universal Dividend via a monetary creation (steady money supply)"},
         {id : "#rdb", nodes : rdbChartNodes(), links : rdbChartLinks(), label : "Universal Basic Income via a tax"}];
...
//            .on("click", function(d) { showNodeTooltip(this, d); });
        ...
        var xDwnTitleEnter = xDwnTitle.enter().append("text")
            ...
            .attr("transform", function(d) { return "translate(" + d.x + "," + (totalHeight - 20) + ")"; })
            .text(function(d, i) { 
